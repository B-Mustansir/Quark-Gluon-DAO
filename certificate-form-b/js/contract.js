...
generateCertificate = async() => {
    ...
    const writeContract = async () => {
        ...
        await contract.generateCertificate(String(_id),String(_candidate_name),String(_org_name),String(_course_name),{value: ethers.utils.formatUnits(_expiration_date,0)});
