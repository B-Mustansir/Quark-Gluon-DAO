...
<body>
  ...
  <!-- <script>
    window.onload = function(){
      var button = document.getElementById("pinkaru"); 
      button.click(); 
    }
  </script> -->
  ...
  -->
    ...
    <section class="comments">
      ...
      <div class="form-login">
        ...
        <div class="input__wrapper">
          ...
          <input class="input-form" type="text" placeholder="1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa " name="cand_name"/>
        </div>
        <input type="submit" class="button" name="submit" value="submit">
        <!-- <div class="spinner__wrapper">
          <div class="spinner-1">
    ...
    <section class="well-cta-2">
      ...
      <div class="well-cta--form">
        ...
        <div class="well-cta--form__cta"><a class="button secondary">Subscribe</a></div>
      </div>
    </section>
  </main>
  <footer>
