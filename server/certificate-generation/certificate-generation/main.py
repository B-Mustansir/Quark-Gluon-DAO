...
arg1 = [str(sys.argv[1])]
paragraph = [str(sys.argv[2])]
# logo ="C:/xampp/htdocs/Quark/Hackathon/certificate-generation/certificate-generation/"+sys.argv[3]
# C:\xampp\htdocs\Quark\Hackathon\OrgLogo\WIN_20230406_10_24_23_Pro.jpg
# logo = "C:/xampp/htdocs/Quark/Hackathon/"+str(sys.argv[3])
...
def make_certificates(name,text,logo,sig_1,head_1,designation_1,sig_2,head_2,designation_2):
    ...
    image_source = Image.open('C:/xampp/htdocs/Quark/Hackathon/certificate-generation/certificate-generation/quarktemplate.png')
   ...
   # arg2 = 22
    ...
    image_source.save("C:/xampp/htdocs/Quark/Hackathon/certificate-generation/certificate-generation/out/" + name +".png")
...
make_certificates(arg1[0],sys.argv[2],"C:/xampp/htdocs/Quark/Hackathon/certificate-generation/certificate-generation/"+sys.argv[3],"C:/xampp/htdocs/Quark/Hackathon/certificate-generation/certificate-generation/"+sys.argv[4],str(sys.argv[7]),str(sys.argv[6]),"C:/xampp/htdocs/Quark/Hackathon/certificate-generation/certificate-generation/"+sys.argv[5],str(sys.argv[8]),str(sys.argv[9]))
print("hi")
