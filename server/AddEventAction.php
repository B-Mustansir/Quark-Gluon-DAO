  ...
  <?php
   ...
   if (isset($_POST['submit'])) {
    ...
    $insertquery = "INSERT INTO `events`(`event_title`, `event_desc`, `design_one`, `design_person_one`, `design_person_one_sign`, `design_two`, `design_person_two`, `design_person_two_sign`, `org_logo_png`, `validity_days`) VALUES ('$event_name','$event_desc','$desg_one','$desg_person_one','$desg_one_folder_exe','$desg_two','$desg_person_two','$desg_two_folder_exe','$org_logo_folder_exe','$validity_days')";
